...
const staty = [
cz = {zbroja: 3, przebicie: 1, szansaNaTrafienie: 1, zasiegStrzalu: 3, szanseStrzlow: [0, 0.85, 0.9]},
...
b = {zbroja: 1, przebicie: 1, szansaNaTrafienie: 0.85, zasiegStrzalu: 3, szanseStrzlow: [1, 0.9, 0.75], walkaWZwarciu: 2},
        ...
        if(daneJednostek[jednostki.indexOf(cel)][2] != 0 && daneJednostek[jednostki.indexOf(jednostka) + 7][2] != 0)
            {
                ...
                if(jednostka != "cz" && jednostka != "w" && jednostka != "b")
                {
                    if(Math.abs(x2 - x1) + Math.abs(y2 - y1) <= staty[x - 7].zasiegStrzalu)
                    {
                        ...
                        {
                            wynik = Math.random()
                            console.log(`Atak: ${wynik}, procent na przebicie: ${(4 - staty[y].zbroja) * 0.3 * staty[x - 7].przebicie}`)
                            if((4 - staty[y].zbroja) * 0.3 * staty[x - 7].przebicie >= wynik)
                            {
                                daneJednostek[y][2] -= 1
                                return true
                            }
        ...
        if(daneJednostek[jednostki.indexOf(cel) + 7][2] != 0 && daneJednostek[jednostki.indexOf(jednostka)][2] != 0)
        {
            ...
            if(jednostka != "cz" && jednostka != "w" && jednostka != "b")
            {
                if(Math.abs(x2 - x1) + Math.abs(y2 - y1) <= staty[x].zasiegStrzalu)
                {
                    ...
                    {
                        wynik = Math.random()
                        console.log(`Atak: ${wynik}, procent na przebicie: ${(4 - staty[y - 7].zbroja) * 0.3 * staty[x].przebicie}`)
                        if((4 - staty[y - 7].zbroja) * 0.3 * staty[x].przebicie >= wynik)
                        {
                            daneJednostek[y][2] -= 1
                            return true
                        }
