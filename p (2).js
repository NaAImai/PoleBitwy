        ...
        if(daneJednostek[jednostki.indexOf(cel)][2] != 0 && daneJednostek[jednostki.indexOf(jednostka) + 7][2] != 0)
            {
                ...
                if(jednostka != "cz" && jednostka != "w" && jednostka != "b")
                {
                    ...
                    {
                        wynik = Math.random()
                        console.log(`Atak: ${wynik}, procent na trafienie: ${staty[x - 7].szanseStrzlow[Math.abs(x2 - x1) + Math.abs(y2 - y1) - 1] * staty[y].szansaNaTrafienie}`)

                        if(wynik <= staty[x - 7].szanseStrzlow[Math.abs(x2 - x1) + Math.abs(y2 - y1) - 1] * staty[y].szansaNaTrafienie)
                        {
                            wynik = Math.random()
                            console.log(`Atak: ${wynik}, procent na przebicie: ${(4 - staty[y].zbroja) * 0.3 * staty[x - 7].szansaNaTrafienie}`)
                            if((4 - staty[y].zbroja) * 0.3 * staty[x - 7].szansaNaTrafienie >= wynik)
                            {
                                daneJednostek[y][2] -= 1
                                return true
                            }
    ...
    else
    {
        if(daneJednostek[jednostki.indexOf(cel) + 7][2] != 0 && daneJednostek[jednostki.indexOf(jednostka)][2] != 0)
        {
            ...
            if(jednostka != "cz" && jednostka != "w" && jednostka != "b")
            {
                ...
                {
                    wynik = Math.random()
                    console.log(`Atak: ${wynik}, procent na trafienie: ${staty[x].szanseStrzlow[Math.abs(x2 - x1) + Math.abs(y2 - y1) - 1] * staty[y - 7].szansaNaTrafienie}`)
                    
                    if(wynik <= staty[x].szanseStrzlow[Math.abs(x2 - x1) + Math.abs(y2 - y1) - 1] * staty[y - 7].szansaNaTrafienie)
                    {
                        wynik = Math.random()
